...
- **Printability** — manifold/watertight geometry, wall thickness, overhang avoidance,
  bridging, tolerances/clearances, bed stability, and orienting parts for strength along
  layer lines.
...
- **Printing** — 3MF/STL export at true mm scale, a full Bambu Studio walkthrough (which
  handles infill and supports for you), and command-line slicing for automation.
...
├── references/
│   ├── printability.md               # manifold rules, walls, overhang avoidance, tolerances, orientation
│   ├── filament-efficiency.md        # solid vs shell, letting the slicer do infill, hollowing big parts
│   ├── bambu-studio.md               # Bambu Studio walkthrough: print, set infill/supports/quality
...
│   ├── slicing-and-export.md         # export formats + CLI slicing (automation)
...
- A slicer to print: **Bambu Studio** for Bambu printers (handles infill/supports
  automatically — the skill walks you through it), or any slicer with a CLI
  (OrcaSlicer/PrusaSlicer/Cura) for headless G-code.
